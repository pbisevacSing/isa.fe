        ...
        <header>
            <div className="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <nav className="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    ...
                    {session == null ?
                        (<Button className="btn btn-sm btn-light" onClick={() => signIn()}> Login </Button>) :
                        (
                            <>
                                <Link href="/" className="me-3 py-2 text-dark text-decoration-none">{session.user?.email}</Link>
                                <Button className="btn btn-sm btn-light" onClick={() => signOut()}> Sign out </Button>
                            </>
                        )
                    }
                </nav>
